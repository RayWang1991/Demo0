...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/BMLayoutConstraint/BMLayoutConstraint.framework"
  install_framework "$BUILT_PRODUCTS_DIR/BTInfiniteScrollView/BTInfiniteScrollView.framework"
